...
public class PinyinUtil {
	...
	static {
		...
		try {
			...
			charProp.load(new FileInputStream("/libs/data/pinyinmap.properties"));
		...
		try {
			...
			indexProp.load(new FileInputStream("/libs/data/pinyinindex.properties"));
