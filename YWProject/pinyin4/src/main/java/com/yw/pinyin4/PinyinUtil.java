...
public class PinyinUtil {
	...
	void init() {
		...
		try {
			InputStream open = mContext.getAssets().open("data/pinyinmap.properties");
		...
		try {
			...
			InputStream open2 = mContext.getAssets().open("data/pinyinindex.properties");
			Properties indexProp = new Properties();
			indexProp.load(open2/*new FileInputStream("/libs/data/pinyinindex.properties")*/);
