...
public class ReflectUtils {
    ...
    public static Object invokeMethod(Object object, String methodName, Object ... methodArgs) {
        ...
        try {
            Method method = clazz.getDeclaredMethod(methodName, (Class<?>[]) methodArgs);
            if (null != method) {
                if (!method.isAccessible()) {
                    method.setAccessible(true); //当方法私有时，设置可访问
                }
    ...
    /** * 反射调用，获取属性值 * * @param object 操作对象 * @param fieldName 对象属性 * @return 属性值 */
    ...
    /** * 反射调用，设置属性值 * * @param clazz 操作类 * @param fieldName 属性名 * @param value 属性的新值 * @return 设置是否成功 */
    public static boolean setStaticField(Class clazz, String fieldName, Object obj, Object value) {
        if (clazz == null) {
            return false;
        }
        try {
