...
import com.yw.ptl_recyclerview.DefaultHeaderAndFooterCreator.DefaultLoadFooterCreator;
import com.yw.ptl_recyclerview.PullToLoad.LoadFooterCreator;
import com.yw.ptl_recyclerview.PullToLoad.OnLoadListener;
import com.yw.ptl_recyclerview.PullToLoad.PullToLoadAdapter;


/**
 * Created by Administrator on 2016/9/21.
 * FooterView - bottomView(max, 1)
 */
public class CustomPullToLoadRecyclerView extends CustomPullToRefreshRecyclerView {
    public CustomPullToLoadRecyclerView(Context context) {
        super(context);
        init(context);
    }

    public CustomPullToLoadRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CustomPullToLoadRecyclerView(Context context, AttributeSet attrs, int defStyle) {
