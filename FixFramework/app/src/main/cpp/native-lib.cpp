...
Java_com_david_fixframework_DexManager_replace(JNIEnv *env, jobject instance, jint sdk,jobject wrongMethod,
                                               jobject rightMethod) {
...
//    ClassObject
    void *dvm_hand=dlopen("libart.so", RTLD_NOW); //libdvm.so
...
Java_com_david_fixframework_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
